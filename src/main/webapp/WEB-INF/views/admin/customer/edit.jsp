                    ...
                    <form:form modelAttribute="modelBuildingEdit" cssClass="form-horizontal" id="formEdit" method="get">
                            ...
                            <div class="col-sm-2">
                                <select class="form-control" name="district">
                                    ...
                                    <c:forEach items="${districts}" var="item">
                                        ...
                                        &lt;%&ndash;<option ${item.selected} value="${item.code}">${item.name}</option>&ndash;%&gt;
                                    </c:forEach>
                                </select>
                            </div>
                        </div>
                       ...
                       <div class="form-group">
                        ...
                        &lt;%&ndash;<div class="form-group">&ndash;%&gt;
                            &lt;%&ndash;<label class="col-sm-3 control-label no-padding-right"> Phí dịch vụ </label>&ndash;%&gt;
                            &lt;%&ndash;<div class="col-sm-9">&ndash;%&gt;
                                &lt;%&ndash;<form:input path="serviceFee" cssClass="form-control"/>&ndash;%&gt;
                            &lt;%&ndash;</div>&ndash;%&gt;
                        &lt;%&ndash;</div>&ndash;%&gt;
